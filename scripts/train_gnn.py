...
# pretrained_path = "./checkpoints/best_gnn_model_v4.pt"
# if pretrained_path:
...
plot_loss_curves(train_losses, val_losses, title="GNN Training Loss", save_path='./plots/gnn/GNNLoss.pdf', log_scale=False)
